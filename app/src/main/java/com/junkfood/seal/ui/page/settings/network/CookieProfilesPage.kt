                    ...
                    try {
                        context.contentResolver.openInputStream(uri)?.use { inputStream ->
                            ...
                            withContext(Dispatchers.Main) {
                                Toast.makeText(context, "Cookies importadas correctamente", Toast.LENGTH_SHORT).show()
                            }
                        }
                    } catch (e: Exception) {
                        e.printStackTrace()
                        withContext(Dispatchers.Main) {
                            Toast.makeText(context, "Error al importar cookies", Toast.LENGTH_SHORT).show()
                        }
                    }
                }
            }
            ...
            LargeTopAppBar(
                ...
                actions = {
                    ...
                    DropdownMenu(expanded = expanded, onDismissRequest = { expanded = false }) {
                        ...
                        DropdownMenuItem(
                            leadingIcon = { Icon(Icons.Outlined.Cookie, null) },
                            text = { Text(stringResource(id = R.string.import_cookies_txt)) },
                            onClick = {
                                expanded = false
